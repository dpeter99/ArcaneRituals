...
public class SacrificialKnifeHUD extends AbstractGui {
    ...
    private TextureRegion flask;
    private TextureRegion flask_background;
    private TextureRegion blood;

    public SacrificialKnifeHUD(Minecraft clientIn) {
        this.client = clientIn;

        flask_background = new TextureRegion(24,0,24,48, 128,64);

        flask = new TextureRegion(0,0,24,48, 128,64);

        blood = new TextureRegion(48, 8,24, 40 , 128,64);
    }
    ...
    public void render(MatrixStack stack, MainWindow window){
        ...
        if(itemStack.getItem().equals(ArcaneItems.sacrificial_knife)){
            ...
            TextureRegion draw_blood =  new TextureRegion(48, (int) (8+(40-bloodHeight)),24, bloodHeight , 128,64);
